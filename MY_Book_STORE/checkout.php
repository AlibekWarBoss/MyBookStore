...
?>
	...
	<form method="post" action="purchase.php" class="form-horizontal">
		...
		<div class="form-group">
			<label style="color: #ffffff" for="address" class="control-label col-md-4">Address</label>
			<div class="col-md-4">
				<input type="text" name="address" class="col-md-4" class="form-control">
			</div>
		</div>
		<div class="form-group">
			<label style="color: #ffffff" for="city" class="control-label col-md-4">City</label>
			<div class="col-md-4">
				<input type="text" name="city" class="col-md-4" class="form-control">
			</div>
		</div>
		<div class="form-group">
			<label style="color: #ffffff" for="zip_code" class="control-label col-md-4">Zip Code</label>
			<div class="col-md-4">
				<input type="text" name="zip_code" class="col-md-4" class="form-control">
			</div>
		</div>
		<div class="form-group">
			<label style="color: #ffffff" for="country" class="control-label col-md-4">Country</label>
			<div class="col-md-4">
